...
Dự án phân tích hoạt động kinh doanh thương mại điện tử (E-Commerce Sales Analysis) sử dụng tập dữ liệu giao dịch thực tế với quy mô 1.000 bản ghi. Dự án bao gồm toàn bộ vòng đời phân tích dữ liệu: từ việc nhập dữ liệu trực tiếp từ tệp CSV vào hệ quản trị cơ sở dữ liệu **SQL Server**, thực thi hệ thống truy vấn phân tích nâng cao giải quyết các bài toán kinh doanh trọng tâm, cho tới thiết kế Dashboard trực quan tương tác trên **Power BI**, tài liệu hóa báo cáo và slide thuyết trình.

---

## 📋 Mục tiêu
Mục tiêu cốt lõi của dự án là phân tích sâu hoạt động kinh doanh thương mại điện tử nhằm tìm ra các insight giá trị về:
1.  **Doanh thu theo thời gian** (tháng trong năm, ngày trong tuần).
2.  **Cơ cấu sản phẩm và danh mục sản phẩm** đóng góp doanh thu chủ chốt.
...
## 🛠️ Công cụ
*   **SQL Server:** Lưu trữ dữ liệu và thực hiện các truy vấn phân tích chuyên sâu (sử dụng Subqueries, CTEs, Window Functions như `ROW_NUMBER()`).
*   **Power BI Desktop:** Viết các DAX Messure, thiết lập mô hình dữ liệu và xây dựng dashboard tương tác chuyên nghiệp.
...
*   *Mục tiêu:* Xác định nhóm ngành hàng chủ lực để định hình chiến lược phân bổ nguồn lực kinh doanh.
*   *Mã SQL:*
    ```sql
    SELECT TOP 5
        Category,
...
Nhằm giúp ban quản lý dễ dàng giám sát KPIs theo thời gian thực và tự do tương tác, dữ liệu từ SQL Server đã được kết nối trực tiếp với Power BI Desktop để thiết kế dashboard **"E-Commerce Sales Analytics Dashboard"** với các tiêu chuẩn thiết kế chuyên nghiệp:
...
4.  **Phong cách thiết kế (Theme & Styling):**
    ...
    *   Tông màu chủ đạo là **màu hồng cánh sen đậm (Magenta/Pink)** mang lại diện mạo hiện đại, nổi bật và đồng nhất trên toàn bộ các visual.

---

### Bước 4 & 5: Báo cáo kỹ thuật & Thuyết trình cấp quản lý
*   **Báo cáo Dự án (Project Documentation):** Tài liệu hóa chi tiết toàn bộ các mã truy vấn SQL, kết quả phân tích số liệu và các giải pháp đề xuất.
*   **Slide Thuyết trình:** Thiết kế slide thuyết trình chuyên nghiệp và trực quan để dễ dàng báo cáo

---

## 📈 Đề xuất
*   **Tập trung tối ưu hóa ngành hàng mũi nhọn (Focus Inventory):** Ưu tiên quản lý tồn kho và thiết lập các chính sách bảo hành, hậu mãi tối ưu cho **Laptop** và **Tablet** vì hai sản phẩm này thuộc danh mục Electronics đóng góp tới hơn **78% doanh thu** của toàn hệ thống ($21.61M trên tổng $27.62M).
*   **Chiến lược bán chéo thông minh (Bundle & Cross-sell):** Tận dụng lượng mua khổng lồ của sản phẩm phổ thông như **T-Shirt** (sản phẩm bán chạy nhất về sản lượng - 259 đơn) và phụ kiện (như Backpack) để tạo các combo đóng gói hoặc chương trình khuyến mãi chéo nhằm kích thích mua sắm các thiết bị có giá trị cao.
*   **Tối ưu chiến dịch tiếp thị theo thời gian (Timing Promotions):** Tập trung ngân sách quảng cáo, flash sale, gửi email marketing vào các ngày **Thứ Hai và Thứ Ba** hàng tuần – đây là những khung thời gian ghi nhận hành vi mua sắm mạnh nhất của người tiêu dùng giúp tối đa hóa tỷ lệ chuyển đổi.
*   **Chiến lược marketing phân hóa theo khu vực (City-Segmented Marketing):**
    *   *Tại Bangalore và Kolkata:* Đẩy mạnh quảng cáo các dòng sản phẩm phân khúc cao cấp (premium/high-value offerings) vì đây là những khu vực có giá trị đơn hàng trung bình (AOV) vượt trội (đạt trên 34.000 USD/đơn).
...
## Tác giả
Dự án mô phỏng quy trình xử lý và phân tích dữ liệu E-Commerce Online Sales Analysisr, bao gồm Data Cleaning, SQL Modeling và trực quan hóa qua Power BI.
