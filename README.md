...
Dự án phân tích hoạt động kinh doanh thương mại điện tử (E-Commerce Sales Analysis) sử dụng tập dữ liệu giao dịch thực tế với quy mô 1.000 bản ghi. Dự án bao gồm quá trình phân tích: từ việc nhập dữ liệu trực tiếp từ tệp CSV vào hệ quản trị cơ sở dữ liệu SQL Server, thực thi hệ thống truy vấn phân tích nâng cao để giải quyết các bài toán kinh doanh trọng tâm, cho tới thiết kế dashboard tương tác trên Power BI, tài liệu hóa báo cáo và slide thuyết trình.
...
Dữ liệu từ tệp CSV được kiểm tra cấu trúc sơ bộ và import trực tiếp vào hệ quản trị cơ sở dữ liệu SQL Server trước khi chạy các câu lệnh truy vấn.
...
*   Sản phẩm bán chạy nhất theo số lượng: **T-Shirt (259 sản phẩm).
*   Sản phẩm bán chạy nhất theo doanh thu: Laptop (11,411,335.17 USD).
...
**Bố cục trực quan & Hệ thống biểu đồ:**
